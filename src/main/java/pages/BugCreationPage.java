...
public class BugCreationPage {
    ...
    public void selectPriority(String priority) {
        // Scroll to the priority field if it's not visible
        ...
        // Locator for the dynamic priority option
        By priorityOption = By.xpath("//div[text()='" + priority + "']");

        // Wait for the specific priority option to become clickable and select it
